...
function UsersTab() {
    ...
    return (
        <div className="flex flex-col p-4 bg-[#0A1B2F]" style={{ height: tabHeight }}>
            ...
            <div className="flex flex-col items-center gap-4 pt-4">
                <div className="flex w-full gap-4">
                    ...
                    {/* Leave room button */}
                    <button
                        className="flex flex-grow items-center justify-center rounded-md bg-[#20C997] p-3 text-black"
                        onClick={leaveRoom}
                        title="Leave room"
                    >
                        <GoSignOut size={22} />
