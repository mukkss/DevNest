...
function RunTab() {
    ...
    return (
        <div
            className="flex flex-col items-center gap-2 p-4 bg-[#0A1B2F]"
        ...
        >
            ...
            <div className="flex h-[90%] w-full flex-col items-end gap-2 md:h-[92%]">
                ...
                />
                <button
                    className="flex w-full justify-center rounded-md bg-[#20C997] p-2 font-bold text-black outline-none disabled:cursor-not-allowed disabled:opacity-50"
                    onClick={runCode}
                    disabled={isRunning}
                >
                    Run
